...
#define BPDU_ROOT_NOT_TIMEOUT 0
#define BPDU_ROOT_LC_TIMEOUT 1
#define BPDU_ROOT_FC_TIMEOUT 2
...
#define DEFAULT_INTERVAL_TIME DEFAULT_ADJUST_TIME*DEFAULT_HELLO_TIME*1000 /*200 mili second*/
